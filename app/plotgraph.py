...
from modelsScrapers import MyEncoder

datas = []
with open("fichiers/friends-Mike Tsebo.csv",'rt',encoding="utf-8")as f:
    reader=csv.reader(f)
    for row in reader:
        datas.append(row)
nodes=[]
...
print('je fais ce que u dis mike')